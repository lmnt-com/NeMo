...
class PunctuationCapitalizationModelConfig:
    ...
    common_dataset_parameters: Optional[CommonDatasetParametersConfig] = field(default_factory=lambda: CommonDatasetParametersConfig())
...
class PunctuationCapitalizationConfig(NemoConfig):
    ...
    exp_manager: Optional[ExpManagerConfig] = field(default_factory=lambda: ExpManagerConfig(name=name, files_to_copy=[]))
...
class PunctuationCapitalizationLexicalAudioConfig(PunctuationCapitalizationConfig):
    model: PunctuationCapitalizationLexicalAudioModelConfig = field(default_factory=lambda: PunctuationCapitalizationLexicalAudioModelConfig())
